# Example: Searching for certificates by name

You can search certificates by their Common Name (CN) or Subject Alternative
Name (SAN).

**To search certificates by name**
...
1. In the JSON body, specify the "OR" joinexpression operator and the "FIND"
   operator for the name value for subjectCN and subjectAlternativeNameDns. For
